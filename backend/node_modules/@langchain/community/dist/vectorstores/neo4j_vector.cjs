...
class Neo4jVectorStore extends vectorstores_1.VectorStore {
    ...
    static async initialize(embeddings, config) {
        ...
        const { preDeleteCollection = false, nodeLabel = "Chunk", textNodeProperty = "text", embeddingNodeProperty = "embedding", keywordIndexName = "keyword", indexName = "vector", retrievalQuery = "", searchType = DEFAULT_SEARCH_TYPE, indexType = DEFAULT_INDEX_TYPE, } = config;
